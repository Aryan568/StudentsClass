...
public class tenth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] img1 = {"image1", "image2", "image3", "image4", "image5", "chemical"};
        String[] img2 = {"imageA", "imageB", "imageC", "bases"};
        String[] img3 = {"imageA", "imageB", "imageC", "and"};
        String[] img4 = {"imageA", "imageB", "imageC", "compounds"};
        String[] img5 = {"imageA", "imageB", "imageC", "elements"};
