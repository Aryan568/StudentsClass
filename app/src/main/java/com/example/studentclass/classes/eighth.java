...
public class eighth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] img1 = {"image1", "image2", "image3", "image4", "image5", "crop"};
        String[] img2 = {"imageA", "imageB", "imageC", "microorganisms"};
        String[] img3 = {"imageA", "imageB", "imageC", "synthetic"};
        String[] img4 = {"imageA", "imageB", "imageC", "metals"};
        String[] img5 = {"imageA", "imageB", "imageC", "coal"};
