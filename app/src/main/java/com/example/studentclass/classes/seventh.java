...
public class seventh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] img1 = {"image1", "image2", "image3", "image4", "image5", "plants"};
        String[] img2 = {"imageA", "imageB", "imageC", "animals"};
        String[] img3 = {"imageA", "imageB", "imageC", "fabric"};
        String[] img4 = {"imageA", "imageB", "imageC", "heat"};
        String[] img5 = {"imageA", "imageB", "imageC", "acids"};
