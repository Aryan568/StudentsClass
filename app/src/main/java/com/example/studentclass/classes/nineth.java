...
public class nineth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] img1 = {"image1", "image2", "image3", "image4", "image5", "matter"};
        String[] img2 = {"imageA", "imageB", "imageC", "around"};
        String[] img3 = {"imageA", "imageB", "imageC", "atoms"};
        String[] img4 = {"imageA", "imageB", "imageC", "structure"};
        String[] img5 = {"imageA", "imageB", "imageC", "fundamental"};
